...
public class FeatureOption {
	...
	private boolean bypassPwd = false;
	private boolean reviewTrash = false;
	private boolean resaveMessage = false;
	private boolean togglePlayMsgTimestamp = false;
	private boolean adminNotificationChannel = false;
	private boolean scPbBlockSender = false;
	private boolean scPbPrintFax = false;
	private boolean scPbCopyMsgToAnotherMb = false;
	private boolean scPbDeleteMessage = false;
	private boolean scPbReplyMessage = false;
	private boolean scPbReturnCall = false;
	private boolean playMessages = false;
	private boolean callerReplayMessage = false;
	private boolean subscriberPauseMessage = false;
	private boolean subscriberPlayOptions = false;
	private boolean copyMsgToAnotherMb = false;
	private boolean deleteMessage = false;
	private boolean replyMessage = false;
	private boolean deleteDepositMessage = false;
	private boolean blockSender = false;
	private boolean recordMessages = false;
	private boolean subscriberDeliveryOptions = false;
	private boolean subscriberUrgentMessage = false;
	private boolean subscriberPrivateMessage = false;
	private boolean returnReceipt = false;
	private boolean addressByMailbox = false;
	private boolean addressByGrouplist = false;
	private boolean addressByName = false;
	private boolean addressByTelephone = false;
	private boolean greetingsMenu = false;
	private boolean greetingOptions = false;
	private boolean greetingExtendedAbsence = false;
	private boolean personalOptions = false;
	private boolean faxOptions = false;
	private boolean primaryFax = false;
	private boolean secondaryFax = false;
	private boolean autoFaxDelivery = false;
	private boolean mwiOptions = false;
	private boolean personalPreferences = false;
	private boolean playbackPreferences = false;
	private boolean playMsgTimeDate = false;
	private boolean nameOptions = false;
	private boolean operatorTransfer = false;
	private boolean calleridRestriction = false;
	private boolean undeleteMessages = false;
	private boolean makeACall = false;
	private boolean callbackNumber = false;
	private boolean callerRecordMessage = false;
	private boolean callerSendMessage = false;
	private boolean depositContinueMessage = false;
	private boolean subscriberOperatorTransfer = false;
	private boolean loginPwd = false;
	private boolean reid = false;
	private boolean immediateRecord = false;
	private boolean callerAdditionalHelp = false;
	private boolean callerDeliveryOptions = false;
	private boolean callerUrgentMessage = false;
	private boolean callerPrivateMessage = false;
	private boolean callerPreviousMenu = false;
	private boolean endCall = false;
	private boolean returnToMainMenu = false;
	private boolean additionalHelp = false;
	private boolean addressingMode2 = false;
	private boolean adminAllowAni = false;
	private boolean autoPlay = false;
	private boolean automaticCallback = false;
	private boolean availability = false;
	private boolean busyGreeting = false;
	private boolean callerOptionsPrompt = false;
	private boolean callerRecordPrompt = false;
	private boolean commonAccessHashLogin = false;
	private boolean commonAccessLoginPrompt = false;
	private boolean customGreetings = false;
	private boolean deliveryNotification = false;
	private boolean depositContinueRecording = false;
	private boolean familySummary = false;
	private boolean greetingForwardingNumber = false;
	private boolean greetingMode2 = false;
	private boolean guiChildDigit = false;
	private boolean guiChildNumber = false;
	private boolean guiDepositPwd = false;
	private boolean guiForwardGreeting = false;
	private boolean guiForwardingNumber = false;
	private boolean guiPlayAni = false;
	private boolean guiPlayCalledNumber = false;
	private boolean guiPlayMsgHeader = false;
	private boolean guiSaveEmtpyMsg = false;
	private boolean guiTimeZone = false;
	private boolean guiV2tEnable = false;
	private boolean guiVvmEnable = false;
	private boolean mcnOption = false;
	private boolean nameDeleteWarning = false;
	private boolean notificationMms = false;
	private boolean notificationOption = false;
	private boolean notificationOutdial = false;
	private boolean notificationWhiteBlackList = false;
	private boolean nutNameGreet = false;
	private boolean nutSystemGreet = false;
	private boolean onCancelReid = false;
	private boolean operatorNumber = false;
	private boolean operatorRevertPwd = false;
	private boolean previousMenu = false;
	private boolean recordMessage = false;
	private boolean replFlag = false;
	private boolean skipResave = false;
	private boolean subscriberFastfwdMessage = false;
	private boolean timeGreetings = false;
